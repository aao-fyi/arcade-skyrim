...
GlobalVariable Property ADESMineMaxCount Auto
...
Keyword Property ADESMineKeyword Auto
...
; Mine Quests / Counts
; =================================
Quest Property ADESMine01Quest Auto
GlobalVariable Property ADESMine01Count Auto

; Mine Quest List
; Returns array of mine quests
Quest[] Function ADESMineQuestList()
	; Create quest list
	Quest[] aaQuests = new Quest[1] ;(0-0)
	; Define quest list
	aaQuests[0] = ADESMine01Quest
	; Return quest list
	Return aaQuests
EndFunction

; Mine Count List
; Returns array of mine counts
GlobalVariable[] Function ADESMineCountList()
	; Create count list
	GlobalVariable[] aaCounts = new GlobalVariable[1] ;(0-0)
	; Define count list
	aaCounts[0] = ADESMine01Count
	; Return count list
	Return aaCounts
EndFunction
; =================================
...
; ADES Actor Unequip
; =================================
Function ADESActorUnequip(Actor aaActor)
	aaActor.UnequipItemSlot(30) ; Head
	aaActor.UnequipItemSlot(31) ; Hair
	aaActor.UnequipItemSlot(32) ; Body
	aaActor.UnequipItemSlot(33) ; Hands
	aaActor.UnequipItemSlot(37) ; Feet
	aaActor.UnequipItemSlot(39) ; Shield
	aaActor.UnequipItemSlot(42) ; Circlet
	aaActor.UnequipItem(aaActor.GetEquippedWeapon(false), true, true) ; Right
	aaActor.UnequipItem(aaActor.GetEquippedWeapon(true), true, true) ; Left
EndFunction
; =================================
