...
Scriptname adesgeneralquestallythalmorscript Extends TopicInfo Hidden
...
; Enable ally marker
ADESAllyThalmorMarker.Enable()

; Change Outfits
FormList GeneralOutfit = ADESGeneralOutfitThalmorList
FormList GuardOutfit = ADESGuardOutfitThalmorList
