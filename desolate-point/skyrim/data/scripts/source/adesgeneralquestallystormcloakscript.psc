...
Scriptname adesgeneralquestallystormcloakscript Extends TopicInfo Hidden
...
; Enable ally marker
ADESAllyStormcloakMarker.Enable()

; Change Outfits
FormList GeneralOutfit = ADESGeneralOutfitStormcloakList
FormList GuardOutfit = ADESGuardOutfitStormcloakList
