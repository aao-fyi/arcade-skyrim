Scriptname ARTSBoosItemProgressScript extends ReferenceAlias  

import game
import debug

;---
referenceAlias property ARTS01BossItemMarkerAlias auto
referenceAlias property ARTS02BossItemMarkerAlias auto
referenceAlias property ARTS03BossItemMarkerAlias auto
referenceAlias property ARTS04BossItemMarkerAlias auto
;---
...
;---
				if (objective == 1)
						ARTS01BossItemMarkerAlias.getReference().Disable()
				elseIf (objective == 2)
						ARTS02BossItemMarkerAlias.getReference().Disable()
				elseIf (objective == 3)
						ARTS03BossItemMarkerAlias.getReference().Disable()
				elseIf (objective == 4)
						ARTS04BossItemMarkerAlias.getReference().Disable()
				endIf
				if (ARTS01BossItemMarkerAlias.getReference().isDisabled() && ARTS02BossItemMarkerAlias.getReference().isDisabled() && ARTS03BossItemMarkerAlias.getReference().isDisabled() && ARTS04BossItemMarkerAlias.getReference().isDisabled())
